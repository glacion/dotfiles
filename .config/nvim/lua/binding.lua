...
vim.api.nvim_set_keymap("n", "<A-s>", "<cmd>write<CR>", opts)
vim.api.nvim_set_keymap("i", "<A-s>", "<cmd>write<CR>", opts)
vim.api.nvim_set_keymap("n", "§", "gv", opts)

vim.api.nvim_set_keymap("v", "<TAB>", ">", opts)
vim.api.nvim_set_keymap("v", "<S-TAB>", "<", opts)
vim.api.nvim_set_keymap("n", "<TAB>", "<cmd>><CR>", opts)
vim.api.nvim_set_keymap("n", "<S-TAB>", "<cmd><<CR>", opts)
...
vim.api.nvim_set_keymap("n", "<leader>e", "<cmd>lua vim.lsp.buf.declaration()<CR>", opts)
